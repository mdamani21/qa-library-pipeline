...
![Open Issues](https://img.shields.io/github/issues/mdamani21/qa-library-pipeline)
![Open PRs](https://img.shields.io/github/issues-pr/mdamani21/qa-library-pipeline)
![Last Commit](https://img.shields.io/github/last-commit/mdamani21/qa-library-pipeline)
![CI Pipeline Badge](https://github.com/mdamani21/qa-library-pipeline/actions/workflows/ci.yml/badge.svg)

<mark>*Replace `mdamani21/qa-library-pipeline` with your details*</mark>
...
git clone https://github.com/mdamani21/qa-library-pipeline.git
